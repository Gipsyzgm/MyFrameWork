...
public class PanelNotice : PanelBase {
    ...
    public override void InitComponent()
    {
        ...
        txtVersion = curView.transform.Find("ScrollView/Viewport/goNoticeList_Transform/NoticeItem/GameObject/Version/txtVersion_Text").GetComponent<Text>();
        txtDate = curView.transform.Find("ScrollView/Viewport/goNoticeList_Transform/NoticeItem/GameObject/Date/txtDate_Text").GetComponent<Text>();
        txtContent = curView.transform.Find("ScrollView/Viewport/goNoticeList_Transform/NoticeItem/txtContent_Text").GetComponent<Text>();
        CustomComponent();
    }
